...
/**
 * The business model implementation of {@link ch.entwine.annotations.api.Category}.
 */
public class CategoryImpl extends ResourceImpl implements Category {
  ...
  /**
   * @see ch.entwine.annotations.api.Category#getId()
   */
  @Override
  public long getId() {
    return id;
  ...
  /**
   * @see ch.entwine.annotations.api.Category#getVideoId()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.Category#getScaleId()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.Category#getName()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.Category#getDescription()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.Category#hasDuration()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.Category#getSettings()
   */
  @Override
