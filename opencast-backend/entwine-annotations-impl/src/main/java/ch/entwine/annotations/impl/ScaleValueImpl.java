...
/**
 * The business model implementation of {@link ch.entwine.annotations.api.ScaleValue}.
 */
public class ScaleValueImpl extends ResourceImpl implements ScaleValue {
  ...
  /**
   * @see ch.entwine.annotations.api.ScaleValue#getId()
   */
  @Override
  public long getId() {
    return id;
  ...
  /**
   * @see ch.entwine.annotations.api.ScaleValue#getScaleId()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.ScaleValue#getName()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.ScaleValue#getValue()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.ScaleValue#getOrder()
   */
  @Override
  public int getOrder() {
    return order;
