...
/**
 * The business model implementation of {@link ch.entwine.annotations.api.Scale}.
 */
public class ScaleImpl extends ResourceImpl implements Scale {
  ...
  /**
   * @see ch.entwine.annotations.api.Scale#getId()
   */
  @Override
  public long getId() {
    return id;
  ...
  /**
   * @see ch.entwine.annotations.api.Scale#getVideoId()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.Scale#getName()
   */
  @Override
  ...
  /**
   * @see ch.entwine.annotations.api.Scale#getDescription()
   */
  @Override
